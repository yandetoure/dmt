...
$timeline = [
    ...
    ['year' => '2018', 'label' => 'Adoption de la loi AGEC', 'desc' => "La loi AGEC, adoptée en 2018, vise à lutter contre le gaspillage et à favoriser une économie circulaire en imposant des mesures de prévention, de réemploi et de recyclage des déchets. Cette loi renforce les obligations des entreprises en matière de gestion des déchets et encourage l'adoption de pratiques durables.", 'tag' => 'Loi Majeure'],
    ['year' => '2020', 'label' => 'Entrée en vigueur de l\'obligation de tri des biodéchets', 'desc' => "À partir de 2020, les entreprises sont tenues de trier et de valoriser leurs biodéchets, contribuant ainsi à la réduction des émissions de gaz à effet de serre et à la préservation des ressources naturelles. Cette mesure vise à promouvoir le compostage et la valorisation énergétique des biodéchets.", 'tag' => 'France'],
    ['year' => '2022', 'label' => 'Renforcement de l\'obligation de tri des biodéchets', 'desc' => "En 2022, les entreprises de grande taille sont soumises à un renforcement de l'obligation de tri des biodéchets, afin de promouvoir une gestion responsable des déchets organiques. Cette mesure vise à réduire l'enfouissement des biodéchets et à favoriser leur valorisation.", 'tag' => 'France'],
    ['year' => '2024', 'label' => 'Obligation du tri des déchets quel que soit l\'effectif', 'desc' => "À partir de 2024, toutes les entreprises, quelle que soit leur taille, sont tenues de trier leurs déchets, marquant ainsi une étape importante vers une gestion plus durable des ressources et une économie circulaire. Cette mesure vise à généraliser le tri des déchets et à encourager l'adoption de pratiques responsables en matière de gestion des déchets.", 'tag' => 'Étape Clé'],
];
@endphp
